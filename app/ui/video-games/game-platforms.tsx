export const platformsMap222 = [
  ...
  { value: "nintendo switch", label: "Nintendo Switch", valueDB: 130 },
  { value: "oculus quest 3", label: "Oculus Quest 3", valueDB: 471 },
  { value: "playstation vr 2", label: "PlayStation VR 2", valueDB: 390 },
  { value: "mac", label: "Mac", valueDB: 14 },
  { value: "linux", label: "Linux", valueDB: 3 },
  { value: "ios", label: "iOS", valueDB: 39 },
  { value: "android", label: "Android", valueDB: 34 },
  { value: "playstation 4", label: "PlayStation 4", valueDB: 48 },
  { value: "xbox one", label: "Xbox One", valueDB: 49 },
  { value: "playstation vita", label: "PlayStation Vita", valueDB: 46 },
  { value: "windows mr", label: "Windows MR", valueDB: 161 },
  { value: "oculus vr", label: "Oculus VR", valueDB: 162 },
  { value: "steam vr", label: "Steam VR", valueDB: 163 },
  { value: "playstation vr", label: "PlayStation VR", valueDB: 165 },
  { value: "oculus quest", label: "Oculus Quest", valueDB: 384 },
  { value: "oculus rift", label: "Oculus Rift", valueDB: 385 },
  { value: "oculus quest 2", label: "Oculus Quest 2", valueDB: 386 },
  { value: "nintendo 64", label: "Nintendo 64", valueDB: 4 },
  { value: "nintendo wii", label: "Nintendo Wii", valueDB: 5 },
  { value: "playstation 1", label: "PlayStation 1", valueDB: 7 },
  { value: "playstation 2", label: "PlayStation 2", valueDB: 8 },
  { value: "playstation 3", label: "PlayStation 3", valueDB: 9 },
  { value: "xbox og", label: "Xbox OG", valueDB: 11 },
  { value: "xbox 360", label: "Xbox 360", valueDB: 12 },
  { value: "nintendo ds", label: "Nintendo DS", valueDB: 20 },
  { value: "nintendo 3ds", label: "Nintendo 3DS", valueDB: 37 },
  { value: "psp", label: "PSP", valueDB: 38 },
  { value: "wiiu", label: "WiiU", valueDB: 41 },
  { value: "arcade", label: "Arcade", valueDB: 52 },
  { value: "mobile", label: "Mobile", valueDB: 55 },
  { value: "browser", label: "Browser", valueDB: 82 },
  { value: "virtual boy", label: "Virtual Boy", valueDB: 87 },
  { value: "new nintendo 3ds", label: "New Nintendo 3DS", valueDB: 137 },
  { value: "nintendo dsi", label: "Nintendo DSi", valueDB: 159 },
  { value: "gamecube", label: "GameCube", valueDB: 21 },
  { value: "game boy color", label: "Game Boy Color", valueDB: 22 },
  { value: "sega dreamcast", label: "Sega Dreamcast", valueDB: 23 },
  { value: "game boy advance", label: "Game Boy Advance", valueDB: 24 },
  { value: "sega genesis", label: "Sega Genesis", valueDB: 29 },
  { value: "sega saturn", label: "Sega Saturn", valueDB: 32 },
